...
using BeerTapsAPI.ApiServices;
using BeerTapsAPI.ApiServices.Security;
using BeerTapsAPI.Documentation.Installers;
using BeerTapsAPI.WebApi.Handlers;
using BeerTapsAPI.WebApi.Hypermedia;
using BeerTapsAPI.WebApi.Infrastructure.Installers;
using BeerTapsAPI.Model;
using IQ.Platform.Framework.WebApi.Infrastructure;

namespace BeerTapsAPI.WebApi.Infrastructure
{
    ...
    public class DefaultApiContainer : ApiContainer
    {
        ...
        readonly Assembly _apiDomainServicesAssembly = typeof(ITapApiService).Assembly;
        readonly Assembly _resourceMappersAssembly = typeof(TapApiService).Assembly;
        ...
        protected override Assembly ResourceSpecsAssembly { get { return typeof(TapSpec).Assembly; } }
        protected override Assembly ResourceStateProvidersAssembly { get { return typeof(TapSpec).Assembly; } }
        protected override Assembly ApiAppServicesAssembly { get { return typeof(TapApiService).Assembly; } }
        ...
        {
            return
                _windsorContainer.Resolve<ApiSecurityContextProvidingHandler<BeerTapsAPIApiUser, NullUserContext>>();
        }
